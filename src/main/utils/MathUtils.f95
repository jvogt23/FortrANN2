...
contains
    ...
    function rand_normal() result(rand_normal)
        real(kind=8) :: U_1, U_2
    ...
    function rand_normal_mat(dim1, dim2) result(rand_normal_mat)
    ...
    function rand_normal_arr result(rand_normal_arr)
    ...
    function e_raise(mat) result(e_raise)
